...
## توضیح درباره این فورک

این مخزن یک فورک community-maintained توسط [@MrAlishr](https://github.com/MrAlishr) است که بر پایه پروژه اصلی
[masterking32/MasterHttpRelayVPN](https://github.com/masterking32/MasterHttpRelayVPN/tree/main) ساخته شده است.

در مقایسه با نسخه پایه، تمرکز این فورک فعلا روی تغییرات شاخه Python-testing و مستندسازی آن‌ها است، از جمله:

- توضیح بهتر برای حالت `apps_script`
- بررسی اعتماد گواهی MITM و ابزارهای نصب certificate
- پشتیبانی از `script_id` و `script_ids` به‌صورت round-robin
- تنظیمات پیش‌فرض بهتر برای مصرف کمتر quota
- راهنمای به‌روز انگلیسی و فارسی
...
- [@masterking32](https://github.com/masterking32) برای پروژه پایه
  [MasterHttpRelayVPN](https://github.com/masterking32/MasterHttpRelayVPN/tree/main)
- [@MrAlishr](https://github.com/MrAlishr) برای نگهداری این فورک و مستندسازی تغییرات جدید شاخه Python-testing
- [@abolix](https://github.com/abolix) برای نقش مهم در ممکن شدن این پروژه
